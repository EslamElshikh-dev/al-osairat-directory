  ...
  return (
    <main id="main-content" className={styles.main}>
      <section className={styles.hero}>
        ...
        <div className={`shell ${styles.heroGrid}`}>
          <div className={styles.heroContent}>
            ...
            <p>
              نلتقط التغطيات التي تذكر مركز العسيرات أو إحدى قراه، نزيل التكرار، ثم ننشئ صفحة داخلية
              تعرض الموجز والبيانات الموثقة والمصدر، مع إبقاء النص الكامل لدى الناشر الأصلي.
            </p>
      ...
      <section id="news-method" className={styles.methodSection}>
        <div className={`shell ${styles.methodGrid}`}>
          <div className={styles.methodCopy}>
            ...
            <p>
              ينشئ الدليل صفحة موثقة لكل تغطية دون نسخ المقال المحمي. نعرض عنوانًا ومختصرًا محدودًا واسم الناشر
              وتاريخ النشر، بينما يظهر النص الكامل داخل الدليل فقط للأخبار الأصلية أو المرخّصة لنا.
            </p>
            <ol>
      ...
      <section className={`shell ${styles.notice}`} aria-label="تنبيه حقوق الأخبار">
        ...
        <p><strong>تنبيه:</strong> حقوق الأخبار والصور والنصوص الخارجية محفوظة لناشريها. صفحات الدليل موجزات موثقة وليست نسخًا من المقالات الأصلية.</p>
      </section>
