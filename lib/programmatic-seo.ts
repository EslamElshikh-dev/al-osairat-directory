...
export const serviceIntents: ServiceIntent[] = [
  {
    ...
    intro: 'تجمع هذه الصفحة السجلات التي يوضح تخصصها المنشور العمل في الكهرباء أو تنفيذ أعمال كهربائية، مع إبقاء بيانات الاتصال والموقع كما وردت في الدليل دون ادعاء ترتيب أو أفضلية.',
  ...
  },
  {
    ...
    guidance: 'راجع موقع المكتبة وبيانات التواصل المتاحة في السجل قبل الزيارة، لأن المنتجات وساعات العمل قد تتغير ولا يفترض الدليل توافر منتج بعينه.',
  },
];
...
export const categorySearchProfiles: Partial<Record<DirectoryCategory, CategorySearchProfile>> = {
  ...
  shops: {
    ...
    editorial: 'تغطي الصفحة المحلات والأنشطة التجارية بمختلف تخصصاتها، بينما تحصل التخصصات التي يظهر لها طلب واضح وبيانات كافية - مثل المكتبات - على صفحة متخصصة مستقلة.',
  },
  education: {
  ...
  crafts: {
    ...
    primaryQuery: 'حرفيين في العسيرات',
    supportingTerms: ['كهربائي في العسيرات', 'سباك في العسيرات', 'خدمات فنية في العسيرات'],
    editorial: 'هذه صفحة التجميع الأساسية للخدمات الفنية، بينما تُفصل نوايا البحث الأضيق مثل كهربائي وسباك في صفحات متخصصة عندما تتجاوز حد البيانات والجودة المطلوب.',
  },
};
