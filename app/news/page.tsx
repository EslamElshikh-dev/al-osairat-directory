      ...
      <section className={styles.hero}>
        ...
        <div className={`shell ${styles.heroGrid}`}>
          <div className={styles.heroContent}>
            ...
            <p>
              نلتقط التغطيات التي تذكر مركز العسيرات أو إحدى قراه، نزيل التكرار، ثم ننشئ داخل الدليل
              تغطية عربية كاملة بصياغة أصلية، مع إظهار الناشر والرابط والوقائع الموثقة بوضوح.
            </p>
      ...
      <section id="news-method" className={styles.methodSection}>
        <div className={`shell ${styles.methodGrid}`}>
          <div className={styles.methodCopy}>
            ...
            <p>
              يستخلص الدليل الوقائع المتاحة من المصدر ويحوّلها إلى تغطية صحفية مستقلة متعددة الفقرات دون نسخ
              المقال أو صوره. أما النقل الحرفي للنص الكامل فيظل مقتصرًا على المواد الأصلية أو المرخّصة لنا.
            </p>
            <ol>
              ...
              <li><b>03</b><span><strong>صياغة موثقة</strong> لا تُضاف معلومة من خارج المادة، ويظل الناشر الأصلي ظاهرًا ومرجعه متاحًا.</span></li>
            </ol>
          </div>
