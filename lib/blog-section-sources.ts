export const blogSectionSourceUrls: Record<string, Record<string, string[]>> = {
  ...
  'markets-shopping-al-osairat': {
    'market-map': [
      'https://usayrat.online/directory/shops',
    ],
    'consumer-rights': [
      'https://cpa.gov.eg/',
      'https://www.msit.gov.eg/',
    ],
  },
  'craftsmen-al-osairat': {
    ...
    'fair-review': [
      'https://cpa.gov.eg/',
      'https://usayrat.online/directory/crafts',
    ],
  },
  ...
  'government-postal-services-al-osairat': {
    'define-service': [
      ...
      'https://usayrat.online/directory/government',
    ],
    'post-office': [
      'https://www.egyptpost.org/',
    ],
    'digital-services': [
      'https://digital.gov.eg/',
    ],
  ...
  'how-to-use-al-osairat-directory': {
    'three-search-paths': [
      'https://usayrat.online/directory',
      'https://usayrat.online/villages',
    ],
    'account-tools': [
