...
export const siteConfig = {
  ...
  socialTitle: 'دليل العسيرات | بتدور علي ايه وإحنا ندلّك عليه',
  socialDescription:
    'يا مرحب يا طيب! من قلب العسيرات جمعنالك الأطباء والصيدليات والمحلات والحرفيين والمواصلات وأخبار القرى في دليل محلي قوي وسريع، ببيانات مرتبة ومراجعة مستمرة… من غير لف ولا دوخة.',
